...
fun MainScreen(exmpViewModel: ViewModel){
    ...
    Column(modifier = Modifier
        ...
        Row {
            Text(text = "CONTADOR", fontSize = 40.sp, color = Color(0xFFFF0000), fontWeight = FontWeight.Bold)
        }
        ...
        BottomAppBar(
            ...
            content = {
                Text("ANA JULIA LIMA DE OLIVEIRA", fontWeight = FontWeight.Bold)
                Spacer(modifier = Modifier.width(130.dp))
                Text("RM: 22304", fontWeight = FontWeight.Bold)
            }
        )
    }
}
